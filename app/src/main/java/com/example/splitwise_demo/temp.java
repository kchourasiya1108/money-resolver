...
//
//                    grps.add(grpName);
//                    System.out.print("myman");
//                    Map<String, Object> newGRP = new HashMap<>();//Integer.toString(grps.size()-1)
...
//                }
//            });
//            ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item,spinner_grp);
//
//            adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
//            grpDropdown.setAdapter(adapter);
//            grpDropdown.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
//                @Override
